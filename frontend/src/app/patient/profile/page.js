        ...
        <Card className="shadow-2xl rounded-xl overflow-hidden border-2 border-green-100">
          ...
          <CardContent className="p-8 bg-white">
            <div className="space-y-6 max-w-lg mx-auto">
              <h3 className="text-xl font-bold text-green-700 border-b-2 border-green-200 pb-2">Personal Information</h3>
              <div className="space-y-3">
                <p className="flex justify-between items-center text-lg">
                  <span className="font-semibold text-gray-700">Email:</span>
                  <span className="text-gray-900 font-normal">{userData.email}</span>
                </p>
                <p className="flex justify-between items-center text-lg">
